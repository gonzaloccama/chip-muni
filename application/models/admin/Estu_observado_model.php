...
class Estu_observado_model extends CI_Model

{

	public $v_fields = array('codigo', 'dni_f', 'nombres_f', 'dni_e', 'nombres_e', 'institucion.institucion', 'nivel.nivel', 'observations');
	...
	function getList($table, $pagination = array())
	{
		...
		$this->db->join("institucion", "estu_observado.institucion = institucion.id_institucion", "left");
		$this->db->join("nivel", "estu_observado.nivel = nivel.id_nivel", "left");
