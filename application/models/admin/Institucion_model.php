...

{
	...
	public $v_fields = array('institucion');
	...
	function getList($table, $pagination = array())
	{
		...
		$this->db->select("$table.*  , nivel.nivel as nivel");
	...
	function getListTablePrint($table)
	{

		$this->db->select("$table.id_institucion, $table.institucion, nivel.nivel as nivel");

		$this->db->from($table);

		$this->db->join("nivel", "$table.id_nivel = nivel.id_nivel", "left");
