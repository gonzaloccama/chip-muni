									...
									<select class="form-control select2" name="institucion" id="institucion">
										...
										if (isset($institucion) && !empty($institucion)):
											...
											foreach ($institucion as $key => $value): ?>
												...
												<option value="<?php echo $nivel_ = $value->id_institucion; ?>">
...
<!--								<div class="col-md-4">-->
									<input type="hidden" class="form-control" id="nivel" name="nivel" autocomplete="off"
										   ...
										   value="<?php echo set_value("nivel"); ?>"
...
<!--							</div>-->
								...
								<div class="col-md-4">
									...
									<select class="form-control select2" name="dni_familia" id="dni_familia">
										...
										if (isset($rel_id)) {
											...
											<option selected value="<?php echo /*$_GET['dni_familia']*/
											$rel_id; ?>"><?php echo /*$_GET['dni_familia']*/
												$rel_id; ?></option>
											...
											?>
											<option value="">Seleccionar DNI_Familia</option>
											<option value="<?php echo /*$_GET['dni_familia']*/
											$rel_id; ?>"><?php echo /*$_GET['dni_familia']*/
												$rel_id; ?></option>
											<?php
										}
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									...
									<a type="reset" class="btn btn-warning" onclick="history.back()"><i
