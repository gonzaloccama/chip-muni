...
<!--								</div>-->
									...
									<div class="col-md-4">
										...
										<select class="form-control select2" name="dni_familia" id="dni_familia">
											...
											if (isset($rel_id)) {
												...
												<option selected
														value="<?php echo $rel_id; ?>"><?php echo $rel_id; ?></option>
												<?php
											} else {
												?>
												<option value="">Seleccionar DNI_Familia</option>
												<option value="<?php echo $rel_id; ?>"><?php echo $rel_id; ?></option>
												<?php
											}
											?>
											<!--										--><?php
											...
											<!--													value="-->
											<?php //echo $value->dni; ?><!--" -->
											<?php //echo $value->dni == $estudiante->dni_familia ? 'selected="selected"' : ""; ?><!-->
											-->
											<!---->
											<!--													--><?php //echo $value->dni; ?>
											<!---->
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										...
										<a type="reset" class="btn btn-warning"
