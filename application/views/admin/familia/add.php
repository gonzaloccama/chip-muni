						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<input type="text" class="form-control" id="ape_pat" name="ape_pat" autocomplete="off"
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<input type="text" class="form-control" id="ape_mat" name="ape_mat" autocomplete="off"
...
<!--								<div class="col-sm-4">-->
									...
									<input type="hidden" class="form-control datetimepicker" id="fecha_entrega"
										   name="fecha_entrega"/>
...
<!--							</div>-->
							...
							<input type="hidden" class="form-control" id="cse" name="cse" autocomplete="off"


								   value="<?php echo set_value("cse"); ?>"

							>

							<div class="form-group">

								<label for="cse" class="col-sm-3 control-label"> CSE-SISFOH </label>

								<div class="col-sm-4">

									<input type="text" class="form-control" id="cse" name="cse" disabled
								...
								<div class="col-sm-5">
									...
									<?php echo form_error("cse", "<span class='label label-danger'>", "</span>") ?>
...
<!--								<div class="col-sm-4">-->
<!---->
<!--									<input type="text" class="form-control datetimepicker" id="fecha_registro"-->
<!--										   name="fecha_registro"/>-->
<!---->
<!--								</div>-->
<!---->
